...
impl From<(Corner, CornerTwist)> for CornerPos {
    fn from(value: (Corner, CornerTwist)) -> Self {
        match value {
            ...
            (C::UFR, CT::Clockwise) => CP::FUR,
            (C::UFR, CT::AntiClockwise) => CP::RUF,
            (C::UFL, CT::Oriented) => CP::UFL,
            (C::UFL, CT::Clockwise) => CP::LUF,
            (C::UFL, CT::AntiClockwise) => CP::FUL,
            (C::UBL, CT::Oriented) => CP::UBL,
            (C::UBL, CT::Clockwise) => CP::BUL,
            (C::UBL, CT::AntiClockwise) => CP::LUB,
